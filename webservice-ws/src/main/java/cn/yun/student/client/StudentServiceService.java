...
import cn.yun.student.service.StudentService;
 ...
 * 
 */
@WebServiceClient(name = "StudentServiceService", targetNamespace = "http://service.student.yun.cn/", wsdlLocation = "http://localhost/ws/student/studentService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName STUDENTSERVICESERVICE_QNAME = new QName("http://service.student.yun.cn/", "StudentServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost/ws/student/studentService?WSDL");
    ...
    public StudentService getStudentServicePort() {
        return super.getPort(new QName("http://service.student.yun.cn/", "StudentServicePort"), StudentService.class);
    }
    ...
    public StudentService getStudentServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.student.yun.cn/", "StudentServicePort"), StudentService.class, features);
    }
